...
export const RegisterationScreen10 = styled.div`
  width: 100%;
  display: flex;
...
export const Vector13 = styled.img`
  width: 11.67px;
  height: 11.67px;
  max-width: 100%;
`;
...
export const PatientRegistration = styled.span`
...
export const Label9 = styled.span`
